...
# xtmi and xtma are the lower and upper bounds on the x size of the trap
# ditto for ytmi and ytma, xs and ys are the size in the x and y axis of the SLM in pixels
...
class Display:
    def __init__(self, master):
        ...
        self.frame.pack()
        self.displayimg = tk.Button(self.frame, text = 'Display', width = 25, command = lambda: Lower.plot(app))
